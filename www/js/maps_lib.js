(function (window, undefined) {
    var MapsLib = function (options) {
        ...
        this.locationScope = options.locationScope || "eldoret town";
    ...
    var self = this;
    var selectColumns = 'Name, Facilitytype, Ward, coordinates, Code ';
  ...
  $('a.btn').on('click', function(e) {
    ...
    $(".modal-body").html('<iframe width="100%" height="200%" frameborder="0" scrolling="yes" allowtransparency="false" src="'+url+'"></iframe>');
	});
      ...
      for (var row in data) {
        template = "\
          <div class='row-fluid item-list'>\
            <div class='span13'>\
              <strong><a data-toggle='modal' class='btn' href='https://fusiontables.googleusercontent.com/embedviz?viz=CARD&q=select+*+from+1euHNAy9kG1LMiPuvTjgJjOc25qOqIWmYVCCoZEnD+where+Code="+ data[row][4] +"'data-target='#myModal'>"+ data[row][0] +"</a></strong>\
			  <a class='btn' href='google.navigation:q="+ data[row] [3] +"'><i class='material-icons'>&#xe569;</i></button></a>\
			  <br />\
              " + data[row][1] + "\
              <br />\
              " + data[row][2] + "\
  ...
  //<strong><a id='map_canvas' href='https://www.google.com/maps/dir/?api=1&origin="+self.currentPinpoint+"&destination="+ data[row][3] + "'>" + data[row][0] + "</a></strong>
  //<strong><a id='map_canvas' href='google.navigation:q="+ data[row][3] + ","+ data[row][3] + ""+ data[row][0] + "'>" + data[row][0] + "</a></strong>\
